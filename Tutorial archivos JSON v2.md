...
> ```
> **Notas:**
> - El **`id`** debe coincidir con el `object_id` del nodo del objeto en tu escena.  
...
> ```
> **Notas:**
> - El valor **`instant`** (booleano) permite una transición inmediata o animada.  
...
> ```
> **Notas:**
> - El valor **`instant`** (booleano) permite ocultar la imagen de forma inmediata o con una transición animada.
> 
> ---
> 
